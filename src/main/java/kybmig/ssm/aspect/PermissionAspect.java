...
public class PermissionAspect {
    ...
    public PermissionAspect(HttpServletRequest request, UserService userService,
        ...
        Utility.log("PermissionAspect 注入需要的依赖", request);
...
//            "execution(* kybmig.ssm.controller.TodoController.edit(..)))")
//    public ModelAndView matchSingle2(ProceedingJoinPoint joint) throws Throwable {
